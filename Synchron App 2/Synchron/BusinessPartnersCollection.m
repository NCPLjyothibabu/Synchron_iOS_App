...
@synthesize BPartners,spinner, businessTableView;
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.AdvisorName.text = [NSString stringWithFormat:@"%@ %@",[BPartners[indexPath.row] valueForKey:@"FirstName"],[BPartners[indexPath.row] valueForKey:@"FirstName"]];
